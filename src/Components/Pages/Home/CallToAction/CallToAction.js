...
const CallToAction = () => {
    return (
        <div>
            <div className="my-10 py-6 sm:py-8 lg:py-12">
                <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                    <div className="md:h-80 flex flex-col sm:flex-row bg-gray-600 rounded-lg overflow-hidden shadow-2xl drop-shadow-2xl">
                        ...
                        <div className="w-full sm:w-1/2 lg:w-3/5 flex flex-col p-4 sm:p-8">
                            <h2 className="text-gray-200 text-xl md:text-2xl lg:text-4xl font-bold mb-4">Help center</h2>

                            <p className="max-w-md text-gray-300 mb-8">This is a section of some simple filler text, also known as placeholder text. It shares some characteristics of a real written text.</p>
