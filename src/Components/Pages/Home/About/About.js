                ...
                <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
                    ...
                    <section class="flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16">
                        ...
                        <div class="xl:w-5/12 flex flex-col justify-center sm:text-center lg:text-left lg:py-12 xl:py-24">
                            <p class="text-indigo-500 md:text-lg xl:text-xl font-semibold mb-4 md:mb-6">About me</p>
                        ...
                        <!-- image - start --> */}
                        <div class="flex items-center xl:w-5/12 h-48 lg:h-auto overflow-hidden ">
                            <img src="https://media.istockphoto.com/id/1291682560/photo/young-couple-taking-break-from-sightseeing-for-selfie.jpg?b=1&s=170667a&w=0&k=20&c=xY6GkBrVLvuem6ghTEhaf82ZXN81l7kLU9ytEj9dWVo=" loading="lazy" alt="Photo by Fakurian Design" class="w-full h-auto rounded-lg object-cover object-center" />
                        </div>
                        {/* <!-- image - end --> */}
                    </section>
                </div>
